...
from utils import get_clique_mol, get_mol, get_smiles, set_atommap, enum_assemble, decode_stereo, sanitize, sanitize_smiles
# from vocab import *
...
class MolTree(object):
    ...
    def __init__(self, smiles, cliques, edges, vocab):
        ...
        for i,c in enumerate(cliques):
            ...
            # if node_smiles not in vocab:
            #     print("error!")
            #     print(node_smiles)
                # print(stop)
            node = MolTreeNode(node_smiles, c)
